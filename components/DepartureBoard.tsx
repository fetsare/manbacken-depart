...
const commonPadding = "px-1 sm:px-2 md:px-3 py-0.5 sm:py-1 md:py-1.5";
const headerTextSize = "text-sm sm:text-base md:text-lg lg:text-xl";
const cellTextSize = "text-sm sm:text-base md:text-lg lg:text-xl";
...
export default function DepartureBoard({
  ...
  return (
    <main
      ...
      } min-h-screen bg-white text-black p-2 sm:p-4 relative`}
    >
      {!hideContact ? (
        <Link
          href={"/contact"}
        ...
        <table className="w-full border-separate border-spacing-y-0.5 sm:border-spacing-y-1 table-fixed">
          ...
          <tbody>
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="whitespace-nowrap overflow-hidden text-ellipsis">
                      {departure.station}{" "}
                      <span className="text-orange-500 mx-0.5 sm:mx-1">→</span>{" "}
            ...
            {Array.from({ length: placeholderRows }).map((_, index) => (
              ...
              >
                <td className={commonPadding}>
                  <div className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 bg-gray-300 rounded"></div>
                </td>
                <td className={commonPadding}>
                  <div className="w-8 h-4 sm:w-12 sm:h-5 md:w-16 md:h-6 lg:w-20 lg:h-8 bg-gray-300 rounded-lg"></div>
                </td>
                <td className={commonPadding}>
                  <div className="w-12 h-4 sm:w-16 sm:h-5 md:w-20 md:h-6 lg:w-24 lg:h-8 bg-gray-300 rounded ml-auto"></div>
                </td>
                <td className={commonPadding}>
                  <div className="w-16 h-4 sm:w-20 sm:h-5 md:w-24 md:h-6 lg:w-32 lg:h-8 bg-gray-300 rounded"></div>
                </td>
                <td className={commonPadding}>
                  <div className="w-12 h-4 sm:w-16 sm:h-5 md:w-20 md:h-6 lg:w-24 lg:h-8 bg-gray-300 rounded"></div>
                </td>
                <td className={commonPadding}>
                  <div className="w-12 h-4 sm:w-16 sm:h-5 md:w-20 md:h-6 lg:w-24 lg:h-8 bg-gray-300 rounded ml-auto"></div>
                </td>
